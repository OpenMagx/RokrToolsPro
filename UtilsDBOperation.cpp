...
#endif
    if ( !m_lsMenuGroupList.isEmpty() ) 	{
        m_lsMenuGroupList.clear();
    }
    if ( !m_lsMgxGroupList.isEmpty() )  	{
        m_lsMgxGroupList.clear();
    }
    if ( !m_lsJavaGroupList.isEmpty() )		{
        m_lsJavaGroupList.clear();
    }
    if ( !m_lsNativeGroupList.isEmpty() ) 	{
        m_lsNativeGroupList.clear();
    }
